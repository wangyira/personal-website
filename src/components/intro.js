    ...
    <div id="intro">
      ...
      <div className="right-col" data-aos="fade-left">
        <div className="skinny-paragraph">
          <span>Hi! </span>
          My name is Yiran (Amanda) Wang and I am a rising senior majoring in computer science and minoring in disruptive innovation at USC💡. I was born and raised in Beijing, China🐼, and I moved to Richmond, Virginia✈️, alone to attend high school when I was 13. As a result, I have a deep understanding of different cultures, people, and technology landscapes.
          <br></br><br></br>
